...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = get_dataset(tokenizer=self.tokenizer, type_path="Quora_Paraphrasing_train_small", args=self.hparams)
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(tokenizer=self.tokenizer, type_path="Quora_Paraphrasing_train_small", args=self.hparams)
...
train_path = "paraphrase_data/Quora_Paraphrasing_train_small.csv"
val_path = "paraphrase_data/Quora_Paraphrasing_train_small.csv"
